...
class EmployeeForm:
    ...
    def allowed_file(filename):
        return '.' in filename and \
               filename.rsplit('.', 1)[1].lower() in EmployeeForm.ALLOWED_EXTENSIONS
    ...
    def prepare_data(form_data, file_data):
        ...
        NucleusId = form_data.get('NucleusId', '').strip()
        ...
        image_binary = None
        if image_file and EmployeeForm.allowed_file(image_file.filename):
